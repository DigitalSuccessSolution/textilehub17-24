  ...
  return (
    <div className="fixed left-0 top-[35%] z-[99] flex items-center">
      <motion.div
        ...
        style={{
          background: 'rgba(74,14,23,0.95)', // primaryDark with opacity
      ...
      >
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.background = COLORS.accent; e.currentTarget.style.color = COLORS.primary; }}
