...
export default function Footer() {
  return (
    <footer style={{ background: '#3E2B21', fontFamily: "'Outfit', sans-serif", borderTop: '1px solid rgba(255,255,255,0.08)' }}>
      {/* Accent top gold bar */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14 text-left">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold" style={{ color: 'rgba(248,245,239,0.85)' }}>info@elitethreads.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        >
          <a href="tel:+916353778329" className="hover:underline text-xs font-black flex items-center gap-1.5 transition-colors" style={{ color: '#CDA75E' }}>
            <Phone size={12} /> Call Us: +91 6353778329
          </a>
          
          <div className="flex gap-5 items-center">
             <a href="#" className="text-white opacity-60 hover:opacity-100 hover:text-[#CDA75E] transition-colors"><FacebookIcon /></a>
             <a href="#" className="text-white opacity-60 hover:opacity-100 hover:text-[#CDA75E] transition-colors"><TwitterIcon /></a>
             <a href="#" className="text-white opacity-60 hover:opacity-100 hover:text-[#CDA75E] transition-colors"><InstagramIcon /></a>
             <a href="#" className="text-white opacity-60 hover:opacity-100 hover:text-[#CDA75E] transition-colors"><LinkedinIcon /></a>
          </div>

          <p className="text-xs tracking-wide font-semibold text-center sm:text-right" style={{ color: 'rgba(248,245,239,0.6)' }}>
            © 2026 · All Rights Reserved · ELITE THREADS
          </p>
        </div>
      </div>
    </footer>
