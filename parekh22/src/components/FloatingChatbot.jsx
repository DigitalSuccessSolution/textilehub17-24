  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      {isOpen && (
        ...
        >
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #8B5A2B 0%, #3E2B21 100%)' }}
          >
            ...
            <div className="flex items-start gap-2.5 mb-4">
              ...
              >
                <p className="text-[13px] leading-relaxed" style={{ color: '#330A10' }}>
                  Namaste! 🙏 Welcome to <strong>Elite Threads</strong>. How can I assist you today?
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mt-3 pl-9">
              {['Product Enquiry', 'Trade Enquiry', 'Store Locations'].map(chip => (
                <button
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = '#8B5A2B'; e.currentTarget.style.color = '#8B5A2B'; e.currentTarget.style.background = '#EFF3EB'; }}
          ...
          <div
            ...
            style={{ borderColor: 'rgba(139,90,43,0.15)' }}
          >
            <input
              type="text"
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #8B5A2B 0%, #3E2B21 100%)', boxShadow: '0 3px 10px rgba(139,90,43,0.25)' }}
            >
      ...
      <button
        ...
        style={{
          background: isOpen
            ? 'linear-gradient(135deg, #3E2B21 0%, #8B5A2B 100%)'
            : 'linear-gradient(135deg, #8B5A2B 0%, #3E2B21 100%)',
