...
export default function FloatingSocials() {
  ...
  const socials = [
    { name: 'Instagram', icon: InstagramIcon, url: 'https://instagram.com', color: 'hover:text-[#E1306C]' },
    { name: 'LinkedIn', icon: LinkedinIcon, url: 'https://linkedin.com', color: 'hover:text-[#0077B5]' },
    { name: 'Facebook', icon: FacebookIcon, url: 'https://facebook.com', color: 'hover:text-[#1877F2]' },
    { name: 'Twitter', icon: TwitterIcon, url: 'https://twitter.com', color: 'hover:text-[#1DA1F2]' },
  ];
