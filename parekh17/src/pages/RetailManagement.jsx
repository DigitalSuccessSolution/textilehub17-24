    ...
    <div className="pb-16 w-full">
      ...
      <div className="w-full bg-rosegold-500 text-white py-12 px-6 mb-10 text-center relative overflow-hidden border-b border-rosegold-400/20">
        ...
        <div className="relative z-10">
          <h1 className="text-[#F3ECE0] border-0 pb-0 text-3xl md:text-4xl tracking-wider uppercase font-bold m-0 text-center">Our Management</h1>
          <p className="text-[#C5A880] text-[10px] md:text-xs uppercase tracking-widest mt-2 font-semibold">Experienced Leadership & Vision</p>
        </div>
      </div>
