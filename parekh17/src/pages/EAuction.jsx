    ...
    <div className="pb-20 w-full">
      ...
      <div className="w-full bg-rosegold-500 text-white py-12 px-6 mb-10 text-center relative overflow-hidden border-b border-rosegold-400/20">
        ...
        <div className="relative z-10">
          <h1 className="text-[#F3ECE0] border-0 pb-0 text-3xl md:text-4xl tracking-wider normal-case font-bold m-0 text-center">e-Auction</h1>
          <p className="text-[#C5A880] text-[10px] md:text-xs uppercase tracking-widest mt-2 font-semibold">Digital Liquidation & Auction System</p>
        </div>
      </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white p-8 md:p-12 border border-gray-200 shadow-lg">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="pt-6 text-center flex items-center justify-center gap-2">
              ...
              <a href="mailto:info@varaweaves.com" className="text-rosegold-500 text-[10px] font-semibold tracking-widest hover:underline uppercase">
                info@varaweaves.com
              </a>
            </div>
          </form>
